...
const svgNewFolderActionIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">' +
...
const svgUploadActionIcon = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upload" viewBox="0 0 16 16">' +
...
export class BrowseJS {
    ...
    renderBreadcrumb() {
        ...
        if (hasCreate) {
            ...
            createBtn.innerHTML = svgNewFolderActionIcon;
        ...
        if (hasUpload) {
            ...
            uploadBtn.innerHTML = svgUploadActionIcon;
